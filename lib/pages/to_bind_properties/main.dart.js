...
u=P.n6()
t="http://ec2-18-219-35-108.us-east-2.compute.amazonaws.com/pages/bind_properties/?"+u.gbh(u)
...
q.className="desc"
this.ae(q)
q.appendChild(t.createTextNode("\u6b64\u9879\u64cd\u4f5c\u9700\u8981\u5148\u5173\u8054\u60a8\u7684\u623f\u4ea7\u4fe1\u606f\u3002"))
p=S.kj(t,u)
...
return t})
u($,"pd","m2",function(){return[".host._ngcontent-%ID%{background-color:#E3F2FD}.icon._ngcontent-%ID%{opacity:0.6;display:block;margin-top:10vh;margin-left:auto;margin-right:auto;width:20%;margin-bottom:5vh}.container._ngcontent-%ID%{margin-top:5vh;display:flex;justify-content:center}.btn._ngcontent-%ID%{font-weight:bold;color:#1E88E5}.desc._ngcontent-%ID%{font-size:5vw;opacity:0.8;text-align:left;margin-left:15%;margin-right:15%;margin-bottom:5%;color:#42A5F5}"]})
